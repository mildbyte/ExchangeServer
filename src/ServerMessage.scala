...
case class Executed(orderId: Int, amount: Int, price: BigDecimal) extends ServerMessage {
...
case class BalanceMessage(balance: BigDecimal) extends ServerMessage {override def toString = balance toString}
...
case class LastTradedPrice(price: Option[BigDecimal]) extends ServerMessage {
